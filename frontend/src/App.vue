<template>
  <div class="min-h-screen flex flex-col">
    <div class="navbar bg-base-100 shadow-sm">
      <a class="text-xl font-bold ml-10">Certificate Status Page</a>
    </div>

    <div class="p-5 px-100 flex-1 w-full">
    ...
    <footer class="p-4 bg-gray-100 flex items-center justify-between">
      <aside class="text-left">
        Powered by <a href="https://github.com/ben-burwood/certificate-status-page" target="_blank" class="font-medium text-green-800 hover:text-green-600">Certificate Status Page</a>
      </aside>
      <nav class="text-right">
        <a href="https://github.com/ben-burwood/certificate-status-page" target="_blank" title="Certificate Status Page on GitHub">
