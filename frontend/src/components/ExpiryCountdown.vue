    ...
    <div v-else class="flex gap-5">
        <div>
            <span
                ...
                :style="
                    {
                        '--value': displayValue(timeLeft.days),
                        '--digits': digits(timeLeft.days),
                    } as any
                "
            >
        ...
        <div>
            <span
                ...
                :style="
                    {
                        '--value': displayValue(timeLeft.hours),
                        '--digits': digits(timeLeft.hours),
                    } as any
                "
            >
        ...
        <div>
            <span
                ...
                :style="
                    {
                        '--value': displayValue(timeLeft.minutes),
                        '--digits': digits(timeLeft.minutes),
                    } as any
                "
            >
...
import { expiryUntilCountdown } from "@/utils/expiry";
